...
POTENTIAL_MODAL_ENTIENDO_SELECTOR = os.getenv(
    "POTENTIAL_MODAL_ENTIENDO_SELECTOR", "button:has-text('Entiendo')"
)
POTENTIAL_INTERMEDIATE_LOGIN_SELECTOR = os.getenv(
    "POTENTIAL_INTERMEDIATE_LOGIN_SELECTOR", "#presso-login"
)
INSIDE_SYSTEM_PATTERN_URL = os.getenv(
    "INSIDE_SYSTEM_PATTERN_URL", "**deportescompensar.com/**"
)
